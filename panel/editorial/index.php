...
<head>
    ...
    <title>Editoriales | Panel de control</title>
...
<body class="bg-light">
    ...
    <main>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="navbar-collapse">
                <ul class="nav nav-pills nav-fill bg-light">
                    <li class="nav-item "><a class="nav-link active" href="#" data-toggle="modal" data-target="#agregar_editorial">Nuevo</a></li>
        ...
        <div class="top">
            ...
            <div class="modal fade" id="deleteeditorial">
                <div class="modal-dialog ">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-footer">
                            <a href="#" class="btn btn-success" data-dismiss="modal" id="borrar-editorial-yes">confirmar</a>
            ...
            <div class="modal fade" id="agregar_editorial">
                <div class="modal-dialog ">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body ">
                            <div class='form-group'>
                                ...
                                <input type='text' class='form-control'  id='editoriale'>
                            </div>
                        </div>
                        <div class="modal-footer">
            ...
            <div class="modal fade" id="editeditorial">
                <div class="modal-dialog ">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-footer">
                            <a href="#" class="btn btn-success" data-dismiss="modal" id="savee">Guardar</a>
